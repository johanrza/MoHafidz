          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
              ...
              <div class="d-none d-xl-block ps-2">
                <div>Rahmat</div>
                <div class="mt-1 small text-secondary">Ustadz</div>
              </div>
            </a>
              ...
              <table class="table table-vcenter table-nowrap">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td><?= $i++; ?></td>
                      <td><a href="/profile/<?= $s['id_santri'] ?>" class="link-body-emphasis link-offset-2 link-underline-opacity-75 link-underline-opacity-75-hover"><?= $s['nama']; ?></a></td>
                      <td><?= $s['kelas']; ?></td>
                      <td><span class="badge badge-outline text-teal">rahmat</span></td>
                      <td>2023-08-15</td>
                      <td>
              ...
              <div class="modal-body">
                <div class="mb-3">
                  <div class="mb-3">
                    ...
                    <input type="file" class="form-control <?php ($validation->hasError('tambah-formFile')) ? 'is-invalid' : ''; ?> " id="tambah-formFile" name="tambah-formFile" value="<?= old('tambah-formFile'); ?>" />
                    <div class="invalid-feedback">
                      <?= $validation->getError('tambah-formFile'); ?>
                    </div>
                  </div>
                ...
                <div class="mb-3">
                  <label for="tambah-ttl" class="form-label">Tempat dan Tanggal Lahir</label>
