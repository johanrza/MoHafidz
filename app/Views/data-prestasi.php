        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
          <div class="d-flex">
            ...
            <form class="row" action="/data-prestasi/short-by-date" method="post">
              ...
              <div class="col-auto">
                <input type="date" class="form-control" id="tanggalAkhir" name="tgl-akhir" disabled />
              </div>
              <div class="col-auto">
                <button class="btn btn-primary" id="tampilkan" type="submit" disabled>Tampilkan</button>
              </div>
            </form>
          </div>
